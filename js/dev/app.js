...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const isHeaderInitiallyActive = parent.classList.contains("--header-active");
  ...
  parent.addEventListener("mouseleave", () => {
    ...
    setTimeout(() => {
      if (!parent.matches(":hover") && !html.hasAttribute("data-fls-menu-open") && !isHeaderInitiallyActive) {
  ...
  iconBurger.addEventListener("click", () => {
    const html = document.documentElement;
    if (html.hasAttribute("data-fls-menu-open")) {
      parent.classList.remove("--header-burger-active");
    } else {
      parent.classList.add("--header-burger-active");
    }
  });
});
