...
let bodyLock = (delay = 500) => {
  if (bodyLockStatus) {
    ...
    const lockPaddingValue = scrollBarWidth > 0 ? `${scrollBarWidth}px` : "";
...
function initSliders() {
  if (document.querySelector(".products__slider")) {
    new Swiper(".products__slider", {
      ...
      */
      ...
      on: {
        init(swiper) {
          const nextBtn = document.querySelector(".products__pc-button-next");
          const prevBtn = document.querySelector(".products__pc-button-prev");
          const wrapper = document.querySelector(".products__wrapper");
          const isHovering = () => [wrapper, nextBtn, prevBtn].some((el) => el == null ? void 0 : el.matches(":hover"));
          const showButtons = () => {
            if (!prevBtn.classList.contains("swiper-button-disabled")) {
              prevBtn.classList.add("products__pc-button-prev--hover");
            }
            if (!nextBtn.classList.contains("swiper-button-disabled")) {
              nextBtn.classList.add("products__pc-button-next--hover");
            }
          };
          const hideButtons = () => {
            prevBtn.classList.remove("products__pc-button-prev--hover");
            nextBtn.classList.remove("products__pc-button-next--hover");
          };
          const updateButtons = () => {
            if (prevBtn) {
          ...
          if (wrapper && nextBtn && prevBtn) {
            const targets = [wrapper, nextBtn, prevBtn];
            let hideTimeout;
            const isInsideTarget = () => targets.some((el) => el == null ? void 0 : el.matches(":hover"));
            targets.forEach((el) => {
  ...
  if (document.querySelector(".posters__slider")) {
  ...
  if (document.querySelector(".categories__slider")) {
    new Swiper(".categories__slider", {
      ...
      */
      ...
      on: {
        init(swiper) {
          const nextBtn = document.querySelector(".categories__pc-button-next");
          const prevBtn = document.querySelector(".categories__pc-button-prev");
          const wrapper = document.querySelector(".categories__wrapper");
          const isHovering = () => [wrapper, nextBtn, prevBtn].some((el) => el == null ? void 0 : el.matches(":hover"));
          const showButtons = () => {
            if (!prevBtn.classList.contains("swiper-button-disabled")) {
              prevBtn.classList.add("categories__pc-button-prev--hover");
            }
            if (!nextBtn.classList.contains("swiper-button-disabled")) {
              nextBtn.classList.add("categories__pc-button-next--hover");
            }
          };
          const hideButtons = () => {
            prevBtn.classList.remove("categories__pc-button-prev--hover");
            nextBtn.classList.remove("categories__pc-button-next--hover");
          };
          const updateButtons = () => {
            if (prevBtn) {
              prevBtn.classList.toggle("swiper-button-disabled", swiper.isBeginning);
  ...
  if (document.querySelector(".review__slider")) {
    new Swiper(".review__slider", {
      ...
      */
      ...
      on: {
        init(swiper) {
          const nextBtn = document.querySelector(".review__pc-button-next");
          const prevBtn = document.querySelector(".review__pc-button-prev");
          const wrapper = document.querySelector(".review__wrapper");
          const isHovering = () => [wrapper, nextBtn, prevBtn].some((el) => el == null ? void 0 : el.matches(":hover"));
          const showButtons = () => {
            if (!prevBtn.classList.contains("swiper-button-disabled")) {
              prevBtn.classList.add("review__pc-button-prev--hover");
            }
            if (!nextBtn.classList.contains("swiper-button-disabled")) {
              nextBtn.classList.add("review__pc-button-next--hover");
            }
          };
          const hideButtons = () => {
            prevBtn.classList.remove("review__pc-button-prev--hover");
            nextBtn.classList.remove("review__pc-button-next--hover");
          };
          const updateButtons = () => {
            if (prevBtn) {
              prevBtn.classList.toggle("swiper-button-disabled", swiper.isBeginning);
  ...
  if (document.querySelector(".inst__slider")) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const trigger = document.querySelector(".spollers-menu__title");
  const target = document.querySelector(".spollers-menu__body");
  const stepBack = document.querySelector(".spollers-menu__back");
  const iconBurger = document.querySelector(".icon-menu");
  if (!parent || !trigger || !target || !stepBack || !iconBurger) {
    console.warn("Missing some DOM elements");
    return;
  }
  setTimeout(() => {
  ...
  const openMenu = () => {
    target.classList.add("spollers-menu__body--open");
    trigger.classList.add("spollers-menu__title--open");
  };
  const closeMenu = () => {
    target.classList.remove("spollers-menu__body--open");
    trigger.classList.remove("spollers-menu__title--open");
  };
  ...
  parent.addEventListener("mouseleave", () => {
    ...
    const hasOpenClass = trigger.classList.contains("spollers-menu__title--open");
    const closeDelay = hasOpenClass ? 300 : 150;
    setTimeout(() => {
    ...
    setTimeout(() => {
      if (!parent.matches(":hover") && !html.hasAttribute("data-fls-menu-open")) {
